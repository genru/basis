...
class ProductTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Acme.DemoBundle.Model.map.ProductTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Acme\\DemoBundle\\Model\\Product');
    ...
    {
        $this->addRelation('Key', 'Acme\\DemoBundle\\Model\\Key', RelationMap::ONE_TO_MANY, array('id' => 'product_id', ), null, null, 'Keys');
    } // buildRelations()
