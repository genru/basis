...
class OrderTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Acme.DemoBundle.Model.map.OrderTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Acme\\DemoBundle\\Model\\Order');
  ...
  3 => 'CANCELLED',
    ...
    {
        $this->addRelation('Customer', 'Acme\\DemoBundle\\Model\\Customer', RelationMap::MANY_TO_ONE, array('customer_id' => 'id', ), null, null);
        $this->addRelation('Key', 'Acme\\DemoBundle\\Model\\Key', RelationMap::ONE_TO_MANY, array('id' => 'order_id', ), null, null, 'Keys');
    } // buildRelations()
