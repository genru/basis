...
class CustomerTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Acme.DemoBundle.Model.map.CustomerTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Acme\\DemoBundle\\Model\\Customer');
    ...
    {
        $this->addRelation('Order', 'Acme\\DemoBundle\\Model\\Order', RelationMap::ONE_TO_MANY, array('id' => 'customer_id', ), null, null, 'Orders');
    } // buildRelations()
