...
use Acme\DemoBundle\Model\CustomerQuery;
...
abstract class BaseCustomer extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Acme\\DemoBundle\\Model\\CustomerPeer';
    ...
    public function setOrganization($v)
    {
        ...
        if ($this->organization !== $v) {
            $this->organization = $v;
            $this->modifiedColumns[] = CustomerPeer::ORGANIZATION;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `basis_customer` (%s) VALUES (%s)',
