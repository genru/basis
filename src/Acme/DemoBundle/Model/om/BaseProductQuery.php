...
abstract class BaseProductQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Acme\\DemoBundle\\Model\\Product';
        }
    ...
    {
        $sql = 'SELECT `id`, `name`, `created_at`, `updated_at` FROM `basis_product` WHERE `id` = :p0';
        try {
    ...
    public function filterByKey($key, $comparison = null)
    {
        if ($key instanceof Key) {
            return $this
                ->addUsingAlias(ProductPeer::ID, $key->getProductId(), $comparison);
