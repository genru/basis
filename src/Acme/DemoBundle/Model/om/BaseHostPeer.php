...
use Acme\DemoBundle\Model\map\HostTableMap;
...
abstract class BaseHostPeer
{
    ...
    const TABLE_NAME = 'basis_host';

    /** the related Propel class for this table */
    const OM_CLASS = 'Acme\\DemoBundle\\Model\\Host';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Acme\\DemoBundle\\Model\\map\\HostTableMap';
    ...
    const ID = 'basis_host.id';

    /** the column name for the fingerprint field */
    const FINGERPRINT = 'basis_host.fingerprint';

    /** the column name for the created_at field */
    const CREATED_AT = 'basis_host.created_at';

    /** the column name for the updated_at field */
    const UPDATED_AT = 'basis_host.updated_at';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Fingerprint', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'fingerprint', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (HostPeer::ID, HostPeer::FINGERPRINT, HostPeer::CREATED_AT, HostPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'FINGERPRINT', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'fingerprint', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Fingerprint' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'fingerprint' => 1, 'createdAt' => 2, 'updatedAt' => 3, ),
        BasePeer::TYPE_COLNAME => array (HostPeer::ID => 0, HostPeer::FINGERPRINT => 1, HostPeer::CREATED_AT => 2, HostPeer::UPDATED_AT => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'FINGERPRINT' => 1, 'CREATED_AT' => 2, 'UPDATED_AT' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'fingerprint' => 1, 'created_at' => 2, 'updated_at' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(HostPeer::FINGERPRINT);
    ...
    /**
     * Method to invalidate the instance pool of all tables related to basis_host
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseHostPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Acme\DemoBundle\Model\map\HostTableMap());
      }
    }
    ...
    /**
     * Deletes all rows from the basis_host table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
