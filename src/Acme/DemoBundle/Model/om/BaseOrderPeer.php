...
use \PropelException;
use \PropelPDO;
use Acme\DemoBundle\Model\CustomerPeer;
use Acme\DemoBundle\Model\Order;
use Acme\DemoBundle\Model\OrderPeer;
use Acme\DemoBundle\Model\map\OrderTableMap;
...
abstract class BaseOrderPeer
{
    ...
    const TABLE_NAME = 'basis_order';

    /** the related Propel class for this table */
    const OM_CLASS = 'Acme\\DemoBundle\\Model\\Order';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Acme\\DemoBundle\\Model\\map\\OrderTableMap';
    ...
    const AGENT = 'basis_order.agent';

    /** the column name for the trans_id field */
    const TRANS_ID = 'basis_order.trans_id';

    /** the column name for the state field */
    const STATE = 'basis_order.state';
    ...
    const UPDATED_AT = 'basis_order.updated_at';
    ...
    /**
     * An identity map to hold any loaded instances of Order objects.
    ...
    protected static $enumValueSets = array(
        OrderPeer::STATE => array(
            OrderPeer::STATE_PAID,
            OrderPeer::STATE_PENDING,
            OrderPeer::STATE_REFUNDED,
            OrderPeer::STATE_CANCELLED,
        ),
    );
    ...
    {
      return OrderPeer::$enumValueSets;
    }
    ...
    {
        $valueSets = OrderPeer::getValueSets();
    ...
    {
        $values = OrderPeer::getValueSet($colname);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OrderPeer::AGENT);
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = serialize(array((string) $obj->getId(), (string) $obj->getCustomerId()));
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Order) {
                $key = serialize(array((string) $value->getId(), (string) $value->getCustomerId()));
    ...
    /**
     * Method to invalidate the instance pool of all tables related to basis_order
    ...
    {
        return OrderPeer::getSqlValueForEnum(OrderPeer::STATE, $enumVal);
    }
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseOrderPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Acme\DemoBundle\Model\map\OrderTableMap());
      }
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(OrderPeer::CUSTOMER_ID);
            $value = $criteria->remove(OrderPeer::CUSTOMER_ID);
            if ($value) {
                $selectCriteria->add(OrderPeer::CUSTOMER_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(OrderPeer::TABLE_NAME);
            }
    ...
    /**
     * Deletes all rows from the basis_order table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(OrderPeer::ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(OrderPeer::CUSTOMER_ID, $value[1]));
                $criteria->addOr($criterion);
                // we can invalidate the cache for this single PK
                OrderPeer::removeInstanceFromPool($value);
            }
        }
     ...
     * @return Order
     */
    public static function retrieveByPK($id, $customer_id, PropelPDO $con = null) {
        $_instancePoolKey = serialize(array((string) $id, (string) $customer_id));
         if (null !== ($obj = OrderPeer::getInstanceFromPool($_instancePoolKey))) {
             return $obj;
        }
        ...
        $criteria = new Criteria(OrderPeer::DATABASE_NAME);
        $criteria->add(OrderPeer::ID, $id);
        $criteria->add(OrderPeer::CUSTOMER_ID, $customer_id);
