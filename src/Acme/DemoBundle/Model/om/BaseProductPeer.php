...
use Acme\DemoBundle\Model\map\ProductTableMap;
...
abstract class BaseProductPeer
{
    ...
    const TABLE_NAME = 'basis_product';

    /** the related Propel class for this table */
    const OM_CLASS = 'Acme\\DemoBundle\\Model\\Product';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Acme\\DemoBundle\\Model\\map\\ProductTableMap';
    ...
    const ID = 'basis_product.id';

    /** the column name for the name field */
    const NAME = 'basis_product.name';

    /** the column name for the created_at field */
    const CREATED_AT = 'basis_product.created_at';

    /** the column name for the updated_at field */
    const UPDATED_AT = 'basis_product.updated_at';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (ProductPeer::ID, ProductPeer::NAME, ProductPeer::CREATED_AT, ProductPeer::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ProductPeer::ID => 0, ProductPeer::NAME => 1, ProductPeer::CREATED_AT => 2, ProductPeer::UPDATED_AT => 3, ),
    ...
    /**
     * Method to invalidate the instance pool of all tables related to basis_product
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseProductPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Acme\DemoBundle\Model\map\ProductTableMap());
      }
    }
    ...
    /**
     * Deletes all rows from the basis_product table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
