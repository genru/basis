...
abstract class BaseHost extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Acme\\DemoBundle\\Model\\HostPeer';
    ...
    public function setFingerprint($v)
    {
        ...
        if ($this->fingerprint !== $v) {
            $this->fingerprint = $v;
            $this->modifiedColumns[] = HostPeer::FINGERPRINT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->fingerprint = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 4; // 4 = HostPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(HostPeer::FINGERPRINT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `basis_host` (%s) VALUES (%s)',
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setFingerprint($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(HostPeer::FINGERPRINT)) $criteria->add(HostPeer::FINGERPRINT, $this->fingerprint);
    ...
    public function setKeys(PropelCollection $keys, PropelPDO $con = null)
    {
        ...
        $this->keysScheduledForDeletion = clone $keysToDelete;

        foreach ($keysToDelete as $keyRemoved) {
            $keyRemoved->setHost(null);
        }
     ...
     *
     * @return string The value of the 'fingerprint' column
     */
    public function __toString()
    {
        return (string) $this->getFingerprint();
    }
