...
use \PropelException;
use \PropelPDO;
use Acme\DemoBundle\Model\Customer;
use Acme\DemoBundle\Model\CustomerPeer;
use Acme\DemoBundle\Model\map\CustomerTableMap;
...
abstract class BaseCustomerPeer
{
    ...
    const TABLE_NAME = 'basis_customer';

    /** the related Propel class for this table */
    const OM_CLASS = 'Acme\\DemoBundle\\Model\\Customer';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Acme\\DemoBundle\\Model\\map\\CustomerTableMap';
    ...
    const NAME = 'basis_customer.name';
    ...
    const CREATED_AT = 'basis_customer.created_at';

    /** the column name for the updated_at field */
    const UPDATED_AT = 'basis_customer.updated_at';
    ...
    /**
     * Method to invalidate the instance pool of all tables related to basis_customer
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCustomerPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Acme\DemoBundle\Model\map\CustomerTableMap());
      }
    }
    ...
    /**
     * Deletes all rows from the basis_customer table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
