...
use Exina\AdminBundle\Model\OrderItemPeer;
use Exina\AdminBundle\Model\OrderPeer;
use Exina\AdminBundle\Model\ProductPeer;
use Exina\AdminBundle\Model\map\OrderItemTableMap;
...
abstract class BaseOrderItemPeer
{
    ...
    const TABLE_NAME = 'basis_order_item';

    /** the related Propel class for this table */
    const OM_CLASS = 'Exina\\AdminBundle\\Model\\OrderItem';
    ...
    const ORDER_ID = 'basis_order_item.order_id';
    ...
    const PRICE = 'basis_order_item.price';

    /** the column name for the created_at field */
    const CREATED_AT = 'basis_order_item.created_at';

    /** the column name for the updated_at field */
    const UPDATED_AT = 'basis_order_item.updated_at';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'OrderId', 'ProductId', 'Quantity', 'Price', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'orderId', 'productId', 'quantity', 'price', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (OrderItemPeer::ID, OrderItemPeer::ORDER_ID, OrderItemPeer::PRODUCT_ID, OrderItemPeer::QUANTITY, OrderItemPeer::PRICE, OrderItemPeer::CREATED_AT, OrderItemPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ORDER_ID', 'PRODUCT_ID', 'QUANTITY', 'PRICE', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'order_id', 'product_id', 'quantity', 'price', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'OrderId' => 1, 'ProductId' => 2, 'Quantity' => 3, 'Price' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'orderId' => 1, 'productId' => 2, 'quantity' => 3, 'price' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        BasePeer::TYPE_COLNAME => array (OrderItemPeer::ID => 0, OrderItemPeer::ORDER_ID => 1, OrderItemPeer::PRODUCT_ID => 2, OrderItemPeer::QUANTITY => 3, OrderItemPeer::PRICE => 4, OrderItemPeer::CREATED_AT => 5, OrderItemPeer::UPDATED_AT => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ORDER_ID' => 1, 'PRODUCT_ID' => 2, 'QUANTITY' => 3, 'PRICE' => 4, 'CREATED_AT' => 5, 'UPDATED_AT' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'order_id' => 1, 'product_id' => 2, 'quantity' => 3, 'price' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OrderItemPeer::PRICE);
    ...
    /**
     * Method to invalidate the instance pool of all tables related to basis_order_item
    ...
    public static function doCountJoinOrder(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(OrderItemPeer::ORDER_ID, OrderPeer::ID, $join_behavior);
    ...
    public static function doCountJoinProduct(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(OrderItemPeer::PRODUCT_ID, ProductPeer::ID, $join_behavior);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseOrderItemPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Exina\AdminBundle\Model\map\OrderItemTableMap());
      }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(OrderItemPeer::ID) && $criteria->keyContainsValue(OrderItemPeer::ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.OrderItemPeer::ID.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(OrderItemPeer::ID);
            if ($value) {
                $selectCriteria->add(OrderItemPeer::ID, $value, $comparison);
            } else {
    ...
    /**
     * Deletes all rows from the basis_order_item table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
