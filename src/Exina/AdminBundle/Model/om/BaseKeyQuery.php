 ...
 * @method KeyQuery orderByProductKey($order = Criteria::ASC) Order by the product_key column
 ...
 * @method KeyQuery groupByProductKey() Group by the product_key column
 ...
 *
 * @method Key findOneByProductKey(string $product_key) Return the first Key filtered by the product_key column
 ...
 * @method array findByProductKey(string $product_key) Return Key objects filtered by the product_key column
...
abstract class BaseKeyQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Exina\\AdminBundle\\Model\\Key';
        }
    ...
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = KeyPeer::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT `id`, `product_key`, `product_id`, `order_id`, `host_id`, `created_at`, `updated_at` FROM `basis_key` WHERE `id` = :p0';
        try {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $obj = new Key();
            $obj->hydrate($row);
            KeyPeer::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(KeyPeer::ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(KeyPeer::ID, $keys, Criteria::IN);
    }
    ...
    public function filterByProductKey($productKey = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(KeyPeer::PRODUCT_KEY, $productKey, $comparison);
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Exina\AdminBundle\Model\HostQuery A secondary query class using the current class as primary query
     */
    public function useHostQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinHost($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Host', '\Exina\AdminBundle\Model\HostQuery');
    }
    ...
    {
        if ($key) {
            $this->addUsingAlias(KeyPeer::ID, $key->getId(), Criteria::NOT_EQUAL);
        }
