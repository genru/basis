...
abstract class BaseKey extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Exina\\AdminBundle\\Model\\KeyPeer';
    ...
    public function setProductKey($v)
    {
        ...
        if ($this->product_key !== $v) {
            $this->product_key = $v;
            $this->modifiedColumns[] = KeyPeer::PRODUCT_KEY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->product_key = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(KeyPeer::PRODUCT_KEY)) {
    ...
    {
        if (isset($alreadyDumpedObjects['Key'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Key'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(KeyPeer::PRODUCT_KEY)) $criteria->add(KeyPeer::PRODUCT_KEY, $this->product_key);
    ...
    {
        return (string) $this->exportTo(KeyPeer::DEFAULT_STRING_FORMAT);
    }
