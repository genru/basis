...
use Exina\AdminBundle\Model\map\HostTableMap;
...
abstract class BaseHostPeer
{
    ...
    const OM_CLASS = 'Exina\\AdminBundle\\Model\\Host';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Exina\\AdminBundle\\Model\\map\\HostTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseHostPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Exina\AdminBundle\Model\map\HostTableMap());
      }
    }
