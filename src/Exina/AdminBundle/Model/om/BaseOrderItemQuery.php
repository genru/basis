...
abstract class BaseOrderItemQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Exina\\AdminBundle\\Model\\OrderItem';
        }
    ...
    {
        $sql = 'SELECT `id`, `order_id`, `product_id`, `created_at`, `updated_at` FROM `basis_order_item` WHERE `id` = :p0';
        try {
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(OrderItemPeer::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(OrderItemPeer::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByOrderId($orderId = null, $comparison = null)
    {
        if (is_array($orderId)) {
            ...
            if (isset($orderId['min'])) {
                $this->addUsingAlias(OrderItemPeer::ORDER_ID, $orderId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($orderId['max'])) {
                $this->addUsingAlias(OrderItemPeer::ORDER_ID, $orderId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OrderItemPeer::ORDER_ID, $orderId, $comparison);
    }
    ...
    public function filterByProductId($productId = null, $comparison = null)
    {
        if (is_array($productId)) {
            ...
            if (isset($productId['min'])) {
                $this->addUsingAlias(OrderItemPeer::PRODUCT_ID, $productId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($productId['max'])) {
                $this->addUsingAlias(OrderItemPeer::PRODUCT_ID, $productId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OrderItemPeer::PRODUCT_ID, $productId, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(OrderItemPeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(OrderItemPeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OrderItemPeer::CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(OrderItemPeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(OrderItemPeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OrderItemPeer::UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    public function filterByOrder($order, $comparison = null)
    {
        if ($order instanceof Order) {
            return $this
                ->addUsingAlias(OrderItemPeer::ORDER_ID, $order->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(OrderItemPeer::ORDER_ID, $order->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByProduct($product, $comparison = null)
    {
        if ($product instanceof Product) {
            return $this
                ->addUsingAlias(OrderItemPeer::PRODUCT_ID, $product->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(OrderItemPeer::PRODUCT_ID, $product->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    {
        return $this->addUsingAlias(OrderItemPeer::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(OrderItemPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(OrderItemPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(OrderItemPeer::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(OrderItemPeer::CREATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(OrderItemPeer::CREATED_AT);
    }
}
