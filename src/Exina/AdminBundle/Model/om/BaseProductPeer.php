...
use Exina\AdminBundle\Model\map\ProductTableMap;
...
abstract class BaseProductPeer
{
    ...
    const OM_CLASS = 'Exina\\AdminBundle\\Model\\Product';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Exina\\AdminBundle\\Model\\map\\ProductTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseProductPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Exina\AdminBundle\Model\map\ProductTableMap());
      }
    }
