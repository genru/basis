...
abstract class BaseOrderItem extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Exina\\AdminBundle\\Model\\OrderItemPeer';
    ...
    public function setOrderId($v)
    {
        ...
        if ($this->order_id !== $v) {
            $this->order_id = $v;
            $this->modifiedColumns[] = OrderItemPeer::ORDER_ID;
        }
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[] = OrderItemPeer::PRODUCT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = OrderItemPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = OrderItemPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = OrderItemQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(OrderItemPeer::UPDATED_AT)) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OrderItemPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(OrderItemPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(OrderItemPeer::ORDER_ID)) {
        ...
        if ($this->isColumnModified(OrderItemPeer::PRICE)) {
        ...
        $sql = sprintf(
            'INSERT INTO `basis_order_item` (%s) VALUES (%s)',
