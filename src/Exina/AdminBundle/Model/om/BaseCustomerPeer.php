...
use Exina\AdminBundle\Model\map\CustomerTableMap;
...
abstract class BaseCustomerPeer
{
    ...
    const OM_CLASS = 'Exina\\AdminBundle\\Model\\Customer';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCustomerPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Exina\AdminBundle\Model\map\CustomerTableMap());
      }
    }
