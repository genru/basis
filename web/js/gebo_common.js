/* [ ---- Gebo Admin Panel - common ---- ] */
    ...
    gebo_sidebar = {
        init: function() {
            ...
            /*
             *  init active item by chris.gao@newagility.com
             */
            gebo_sidebar.init_item();
        },
        info_box: function(){
        ...
        /* custom init active item 
         * added by chris.gao@newaglity.com
        */
        ,init_item: function() {
            var url = window.location.href;
            // url.match('chaoyan/web/app_dev.php/bill/')
            // alert(url.match('chaoyan/web/app_dev.php/bill/')!=null);

            $('.nav-list li a').each(function(i) {
                $(this).parent().removeClass('active');
                if(null!=url.match($(this).attr('href')+'$')) {
                    $(this).parent().addClass('active');
                    $(this).closest('.accordion-body').addClass('in');
                }
            });
        }
    };
